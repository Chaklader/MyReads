...
class App extends Component {
    ...
    moveBook = (book, shelf) => {
        ...
        if (shelf === 'none') {
            this.setState(currState => ({
                myBooks: currState.myBooks.filter(b => b.id !== book.id)
            }))
        } else {
            book.shelf = shelf;
            this.setState(currState => ({
                myBooks: currState.myBooks.filter(b => b.id !== book.id).concat([book])
            }));
        }
    }
    ...
    render() {
        ...
        if (error) {
            return <div>New work error to retrieve the books. Please, try again!</div>
        }
